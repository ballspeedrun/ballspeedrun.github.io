...
namespace project_1 {
	...
	void init_obj() {
		...
		insert_obj(56, 11, "◆", 1); 
		insert_obj(57, 4, "◆", 1);
		insert_obj(58, 2, "◆", 1); // player
		insert_obj(-1, 7, "■", 2);
		insert_obj(-11, 11, "■", 2);
		insert_obj(-14, 14, "■", 2);
		insert_obj(-15, 15, "■", 2);// barrier
		insert_obj(30, 13, "■", 3); // teleport
		insert_obj(-2, 6, "▲", 4);
		insert_obj(-3, 6, "▼", 4);
		insert_obj(-20, 15, "▲", 4);
		insert_obj(-21, 15, "▼", 4);
		insert_obj(-22, 13, "¤", 4); // spike
		insert_obj(-40, 14, "▓ ", 5);
		insert_obj(-41, 2, "▓ ", 5); // sand
		insert_obj(40, 14, "★", 6); // crown
		insert_obj(-30, 14, "□", 7);
		insert_obj(-31, 6, "□", 7); // tricky square
	}
